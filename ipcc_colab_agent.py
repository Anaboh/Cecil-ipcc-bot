...
class IPCCLLMAgent:
    ...
    def __init__(self):
        ...
        self.llm_models = {
            ...
            'deepseek': {'name': 'DeepSeek', 'provider': 'DeepSeek'},  # New model
    ...
    with gr.Blocks(
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                {'✅' if os.getenv('DEEPSEEK_API_KEY') else '❌'} DeepSeek: {'Available' if os.getenv('DEEPSEEK_API_KEY') else 'No API Key'}<br>
